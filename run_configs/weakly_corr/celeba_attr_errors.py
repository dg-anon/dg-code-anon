...
def sgd_const():
    ...
    search.add_list("dataname", ['CelebA-Attractive-Wearing_Lipstick', 'CelebA-Wearing_Lipstick-Attractive', 'CelebA-Heavy_Makeup-Attractive', 'CelebA-Young-Attractive', 'CelebA-Oval_Face-High_Cheekbones'])
    ...
    search.add_list("lr", [0.001, 0.005])

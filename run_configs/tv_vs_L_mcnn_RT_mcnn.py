...
def sgd_const():
    ...
    search.add_list("noise_method", ['fl_cifar_RTspdc_cm_RTcheck', 'fl_cifar_RTspdc_cm_RTflip'])
    search.add_static_var("fine_labels", 'RT_mCNN')
    search.add_list("random_teacher_width", [1, 2, 5, 10])
    ...
    search.add_static_var("wandb_project_name", 'de-tv-v-L-RTmcnn-cifar-spdc')

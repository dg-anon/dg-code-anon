...
rseed_list = list(np.random.randint(0, 10000, 3))
print(rseed_list)
...
def sgd_const():
    ...
    search.add_static_var("noise_method", 'fl_true_cm_2random')
    ...
    search.add_static_var("wandb_project_name", 'targeted-two-randomk-vary-p-cifar10-wrn')    

...
def sgd_const():
    ...
    search.add_static_var("noise_method", 'fl_true_cm_supercat')
    search.add_static_var("noise_probability", 0.3)
    ...
    search.add_static_var("wandb_project_name", 'supercat-cifar-wrn')    

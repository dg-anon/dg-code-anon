...
def sgd_const():
    ...
    search.add_list("noise_probability", [0.1, 0.3, 0.5, 0.7, 0.9])
    search.add_list("noise_method", ['fl_cifar_OA_cm_super_01'])
    ...
    search.add_static_var("add_batchnorm", '')
    ...
    search.add_list("lr", [0.001, 0.0001])
    ...
    search.add_static_var("wandb_project_name", 'super-cifar10-oa-vary-p-fc')    

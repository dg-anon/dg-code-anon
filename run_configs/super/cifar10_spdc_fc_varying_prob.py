...
def sgd_const():
    ...
    search.add_list("noise_probability", [0.5])
    search.add_static_var("noise_method", 'fl_cifar_spdc_cm_pflip')
    ...
    search.add_static_var("wandb_project_name", 'super-spdc-vary-p-cifar10-fc')    

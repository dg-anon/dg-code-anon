...
def sgd_const():
    ...
    search.add_list("numsamples", [100, 250, 500, 1000, 2000, 5000, 10000, 20000, -1]) #[500, 1000, 2000, 5000, 10000, 20000]
    search.add_static_var("batchsize", 128)
    search.add_static_var("testbatchsize", 128)

    search.add_static_var("noise_probability", 0.4)
    search.add_list("noise_method", ['fl_true_cm_target'])
    ...
    search.add_static_var("wandb_project_name", 'poor-L-numsamples-mcnn-cifar-target-k01')
